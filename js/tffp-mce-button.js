                 ...
                 menu: [
                       {
                        ...
                        text: 'Related',
                        onclick: function() {
                        editor.insertContent("<div class='textbox textbox--related'><header class='textbox__header'><h2 class='textbox__title'>Related</h2></header><div class='textbox__content'>Type your related content here.<ul><li>First</li><li>Second</li></ul></div></div>");
                          }
                        },
                        {
                        text: 'Exercise',
                        onclick: function() {
                        editor.insertContent("<div class='textbox textbox--exercise'><header class='textbox__header'><h2 class='textbox__title'>Exercise</h2></header><div class='textbox__content'>Type your exercises here.<ul><li>First</li><li>Second</li></ul></div></div>");
                          }
                        },
                        {
                        text: 'Activity',
                        onclick: function() {
                        editor.insertContent("<div class='textbox textbox--activity'><header class='textbox__header'><h2 class='textbox__title'>Activity</h2></header><div class='textbox__content'>Type your activities here.<ul><li>First</li><li>Second</li></ul></div></div>");
                          }
                        },
                        {
                        text: 'Task',
                        onclick: function() {
                        editor.insertContent("<div class='textbox textbox--task'><header class='textbox__header'><h2 class='textbox__title'>Task</h2></header><div class='textbox__content'>Type your tasks here.<ul><li>First</li><li>Second</li></ul></div></div>");
                          }
                        }
                       ]
              });
